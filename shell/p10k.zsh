# Generated by Powerlevel10k configuration wizard on 2024-06-08 at 10:45 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 80 characters long, show it in full.
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      # If tag name is at most 80 characters long, show it in full.
      # Otherwise show the first 12 … the last 12.
      # Tip: To always show tag name in full without truncation, delete the next line.
      (( $#tag > 80 )) && tag[13,-13]="…"  # <-- this line
      res+="${meta}#${clean}${tag//\%/%%}"
    fi
  ...
  # Don't show context unless running with privileges, in SSH, or in a container.
